function home() {
        ...
        <div class="cabecalho">
            <div class="texto2">
                ...
                <p>What is Lorem Ipsum?
                    ...
                    industry's standard dummydfghdfgh text ever since the 1500s, when an unknown printer took a galley of type
                    and
    ...
    document.getElementById("grid").innerHTML = exibe;
    ...
    ">
        ...
        ">
            <div class="texto2">
                ...
                text-align: justify
            ">
                    <h3>Assim que possível retornarei o contato</h3>
                    <form action="https://formsubmit.co/tamires.muller@gmail.com" method="POST">
                        <div>
                        ...
                        <div>
                            ...
                            <input type="email" name="email" id="email" class="form-control "
                                placeholder="nome@email.com" value="">
                        </div><br>

                        <button class="btn btn-secondary btn-lg btn-block" onclick="maeFunction() ">Ennviar</button>
                    </form>
                </div>
            </div>
        </div>
